		...
		<div class="container">
			<div class="row top-line animate-box">
				<div class="col-md-6 col-md-offset-3 col-md-push-2 text-left heading">
					<h2>Escríbeme</h2>
					<h3>Si necesitas algo no dudes en consultar</h3>
					<p>Puede ser sólo para tener una idea del proyecto que necesitas. Te puedo guiar para que encuentres lo mejor para ti</p>
				</div>
			</div>
			<div class="row">

			...
			<div class="container">
				<div class="row top-line animate-box">
					<div class="col-md-6 col-md-offset-3 col-md-push-2 text-left heading">
						...
						<p>Diseñadora Gráfica &amp; Diseñadora UI | Fotógrafa aficionada</p>
					</div>
				</div>
				<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6">
								<div class="feature-center animate-box" data-animate-effect="fadeIn">
									...
									<h3>Diseño Web - UI</h3>
									<p>Trabajo para entregar los diseños de sus sitios de la mejor manera que los usuarios puedan navegar en su
										sitio de forma eficiente.</p>
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="feature-center animate-box" data-animate-effect="fadeIn">
